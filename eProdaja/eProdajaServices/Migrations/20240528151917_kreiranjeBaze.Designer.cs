...
namespace eProdajaServices.Migrations
{
    ...
    [Migration("20240528151917_kreiranjeBaze")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eProdajaServices.Database.Dobavljaci", b =>
                {
            ...
            modelBuilder.Entity("eProdajaServices.Database.IzlazStavke", b =>
                {
            ...
            modelBuilder.Entity("eProdajaServices.Database.Izlazi", b =>
                {
                    b.Property<int>("IzlazId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eProdajaServices.Database.JediniceMjere", b =>
                {
            ...
            modelBuilder.Entity("eProdajaServices.Database.Korisnici", b =>
                {
                    b.Property<int>("KorisnikId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eProdajaServices.Database.KorisniciUloge", b =>
                {
            ...
            modelBuilder.Entity("eProdajaServices.Database.Kupci", b =>
                {
            ...
            modelBuilder.Entity("eProdajaServices.Database.NarudzbaStavke", b =>
                {
            ...
            modelBuilder.Entity("eProdajaServices.Database.Narudzbe", b =>
                {
                    b.Property<int>("NarudzbaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eProdajaServices.Database.Ocjene", b =>
                {
            ...
            modelBuilder.Entity("eProdajaServices.Database.Proizvodi", b =>
                {
                    b.Property<int>("ProizvodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eProdajaServices.Database.Skladistum", b =>
                {
                    b.Property<int>("SkladisteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eProdajaServices.Database.UlazStavke", b =>
                {
            ...
            modelBuilder.Entity("eProdajaServices.Database.Ulazi", b =>
                {
                    b.Property<int>("UlazId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eProdajaServices.Database.Uloge", b =>
                {
                    b.Property<int>("UlogaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eProdajaServices.Database.VrsteProizvodum", b =>
                {
                    b.Property<int>("VrstaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eProdajaServices.Database.IzlazStavke", b =>
                {
                    b.HasOne("eProdajaServices.Database.Izlazi", "Izlaz")
                        .WithMany("IzlazStavkes")
                        .HasForeignKey("IzlazId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eProdajaServices.Database.Proizvodi", "Proizvod")
                        .WithMany("IzlazStavkes")
            ...
            modelBuilder.Entity("eProdajaServices.Database.Izlazi", b =>
                {
                    b.HasOne("eProdajaServices.Database.Korisnici", "Korisnik")
                        .WithMany("Izlazis")
                        .HasForeignKey("KorisnikId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eProdajaServices.Database.Narudzbe", "Narudzba")
                        .WithMany("Izlazis")
                        .HasForeignKey("NarudzbaId");

                    b.HasOne("eProdajaServices.Database.Skladistum", "Skladiste")
                        .WithMany("Izlazis")
            ...
            modelBuilder.Entity("eProdajaServices.Database.KorisniciUloge", b =>
                {
                    ...
                    b.HasOne("eProdajaServices.Database.Uloge", "Uloga")
                        .WithMany("KorisniciUloges")
            ...
            modelBuilder.Entity("eProdajaServices.Database.Narudzbe", b =>
                {
                    b.HasOne("eProdajaServices.Database.Kupci", "Kupac")
                        .WithMany("Narudzbes")
            ...
            modelBuilder.Entity("eProdajaServices.Database.Proizvodi", b =>
                {
                    b.HasOne("eProdajaServices.Database.JediniceMjere", "JedinicaMjere")
                        .WithMany("Proizvodis")
                        .HasForeignKey("JedinicaMjereId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eProdajaServices.Database.VrsteProizvodum", "Vrsta")
                        .WithMany("Proizvodis")
            ...
            modelBuilder.Entity("eProdajaServices.Database.UlazStavke", b =>
                {
                    ...
                    b.HasOne("eProdajaServices.Database.Ulazi", "Ulaz")
                        .WithMany("UlazStavkes")
            ...
            modelBuilder.Entity("eProdajaServices.Database.Ulazi", b =>
                {
                    b.HasOne("eProdajaServices.Database.Dobavljaci", "Dobavljac")
                        .WithMany("Ulazis")
